...
const confirmAnexoDocumento = () => {
    anexarDocumento.value = true;
};
...
<template>
    <section class="space-y-6">
        <li @click="confirmAnexoDocumento" class="flex py-2 items-center transition duration-300 hover:text-sky-500 hover:cursor-pointer">
            <svg class="w-6 h-6 text-violet-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path fill-rule="evenodd" d="M9 2.221V7H4.221a2 2 0 0 1 .365-.5L8.5 2.586A2 2 0 0 1 9 2.22ZM11 2v5a2 2 0 0 1-2 2H4v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2h-7ZM8 16a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1Zm1-5a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2H9Z" clip-rule="evenodd"/>
            </svg>
            <span class="ml-3">Documento</span>
        </li>

        <Modal :show="anexarDocumento" @close="closeModal">
            <div class="p-6">
