...
<template>
    <ApplicationLayout title="Novo Usuário">
        <template #breadcrumb>
            <!-- breadcrumb -->
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <ItemBreadcrumb href="" :active="true">Novo Usuário</ItemBreadcrumb>
            </ol>
            <h6 class="mb-0 font-bold capitalize">Novo Usuário</h6>
        </template>
            ...
            <div class="flex flex-wrap -mx-3">
                <div class="flex gap-4 w-full max-w-full px-3">
                    ...
                    <div class="grow p-5 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                        <h6 class="font-bold text-gray-600">Acesso aos Módulos:</h6>
