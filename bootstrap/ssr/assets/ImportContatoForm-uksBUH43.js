  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6"${_scopeId}><h2 class="text-xl font-medium text-gray-900"${_scopeId}> Importar Contato </h2><hr class="my-4"${_scopeId}><div class="mb-5"${_scopeId}><div class="${ssrRenderClass([{
            ...
            return [
              createVNode("div", { class: "p-6" }, [
                createVNode("h2", { class: "text-xl font-medium text-gray-900" }, " Importar Contato "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Lista/Partials/ImportContatoForm.vue");
