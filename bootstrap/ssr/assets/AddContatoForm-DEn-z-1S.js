...
import _sfc_main$4 from "./SelectContatoFilter-BJJTi_2L.js";
const _sfc_main = {
  __name: "AddContatoForm",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        onClick: confirmNovaCampanha,
        cor: "green"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-4 mr-2"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 16.875h3.375m0 0h3.375m-3.375 0V13.5m0 3.375v3.375M6 10.5h2.25a2.25 2.25 0 0 0 2.25-2.25V6a2.25 2.25 0 0 0-2.25-2.25H6A2.25 2.25 0 0 0 3.75 6v2.25A2.25 2.25 0 0 0 6 10.5Zm0 9.75h2.25A2.25 2.25 0 0 0 10.5 18v-2.25a2.25 2.25 0 0 0-2.25-2.25H6a2.25 2.25 0 0 0-2.25 2.25V18A2.25 2.25 0 0 0 6 20.25Zm9.75-9.75H18a2.25 2.25 0 0 0 2.25-2.25V6A2.25 2.25 0 0 0 18 3.75h-2.25A2.25 2.25 0 0 0 13.5 6v2.25a2.25 2.25 0 0 0 2.25 2.25Z"${_scopeId}></path></svg> Contato `);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        show: novaCampanha.value,
        onClose: closeModal,
        "max-width": "xl"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6"${_scopeId}><h6 class="font-bold"${_scopeId}>Adicionar contato a lista:</h6><div class="my-4"${_scopeId}></div><div class="mb-4"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "contato_id",
              class: "mt-1",
              modelValue: unref(form).contato_id,
              "onUpdate:modelValue": ($event) => unref(form).contato_id = $event,
              options: __props.contatos,
              autocomplete: "contato_id"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$5, {
              class: "mt-2",
              message: unref(form).errors.contato_id
            }, null, _parent2, _scopeId));
            ...
            return [
              createVNode("div", { class: "p-6" }, [
                createVNode("h6", { class: "font-bold" }, "Adicionar contato a lista:"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Lista/Partials/AddContatoForm.vue");
