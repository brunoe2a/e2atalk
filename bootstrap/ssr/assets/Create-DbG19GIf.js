...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Novo Usuário" }, _attrs), {
        breadcrumb: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</ol><h6 class="mb-0 font-bold capitalize"${_scopeId}>Novo Usuário</h6>`);
          } else {
            return [
              ...
              createVNode("h6", { class: "mb-0 font-bold capitalize" }, "Novo Usuário")
            ];
          }
        }),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex mb-4"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, {
              for: "telefone",
              class: "text-xs",
              value: "Celular:"
            ...
            _push2(`</div><div class="pl-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, {
              for: "password",
              class: "text-xs",
              value: "Senha:"
            ...
            _push2(`</div></div><div class="grow p-5 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border"${_scopeId}><h6 class="font-bold text-gray-600"${_scopeId}>Acesso aos Módulos:</h6><div class="my-3 border-t"${_scopeId}></div><!--[-->`);
                ...
                createVNode("div", { class: "flex flex-wrap -mx-3" }, [
                  createVNode("div", { class: "flex gap-4 w-full max-w-full px-3" }, [
                    ...
                    createVNode("div", { class: "grow p-5 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border" }, [
                      createVNode("h6", { class: "font-bold text-gray-600" }, "Acesso aos Módulos:"),
